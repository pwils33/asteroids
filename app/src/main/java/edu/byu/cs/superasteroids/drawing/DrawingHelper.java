...
public class DrawingHelper {
     ...
     * @param rotationRadians The rotation on the image in radians
     ...
     */
	public static void drawImage(int imageId, float x, float y, double rotationRadians,
        ...
        float rotationDegrees = (float) GraphicsUtils.radiansToDegrees(rotationRadians);
