...
public class ShipBuildingActivity extends ActivityView implements IShipBuildingView {
	...
	private PartSelectionFragment leftWingFragment = new PartSelectionFragment();
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mainBodyFragment.setPartView(ShipBuildingState.MAIN_BODY);
        ...
        engineFragment.setPartView(ShipBuildingState.ENGINE);
        engineFragment.setController(getController());
        engineFragment.setPartsAdapter(new PartsAdapter(this, 0, new ArrayList<Integer>()));
        cannonFragment.setPartView(ShipBuildingState.CANNON);
        cannonFragment.setController(getController());
        cannonFragment.setPartsAdapter(new PartsAdapter(this, 0, new ArrayList<Integer>()));
        leftWingFragment.setPartView(ShipBuildingState.LEFT_WING);
        leftWingFragment.setController(getController());
        leftWingFragment.setPartsAdapter(new PartsAdapter(this, 0, new ArrayList<Integer>()));
        powerCoreFragment.setPartView(ShipBuildingState.POWER_CORE);
	...
	@Override
	public void animateToView(ShipBuildingState view, ViewDirection animationDirection) {
...
*/
	...
	private PartSelectionFragment getPieceSelectionView(ShipBuildingState view) {
		switch(view) {
			case MAIN_BODY:		return mainBodyFragment;
            case LEFT_WING: 	return leftWingFragment;
	...
	@Override
	public void setPartViewImageList(ShipBuildingState view, List<Integer> partImageIds) {
    ...
    public void setStartGameButton(boolean enabled) {
        ...
        leftWingFragment.setStartGameButton(enabled);
    ...
    @Override
    public void setArrow(ShipBuildingState partView, ViewDirection arrow, boolean visible, String text) {
