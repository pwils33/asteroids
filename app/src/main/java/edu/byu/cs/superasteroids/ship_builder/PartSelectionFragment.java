...
public class PartSelectionFragment extends FragmentView {
    ...
    private ShipBuildingState partView;
    ...
    public void setArrow(ViewDirection arrow, boolean visible, String text) {
        ...
        else if(arrow == ViewDirection.UP) {
        ...
        else if(arrow == ViewDirection.RIGHT) {
        ...
        else if(arrow == ViewDirection.DOWN) {
    ...
    public ShipBuildingState getPartView() {
        return partView;
    }
    ...
    public void setPartView(ShipBuildingState partView) {
