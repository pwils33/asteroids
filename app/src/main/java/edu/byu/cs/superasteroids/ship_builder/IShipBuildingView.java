...
public interface IShipBuildingView extends IView {
     ...
     *                           as it does so.
     */
	void animateToView(ShipBuildingState view, ViewDirection animationDirection);

    /**
     * Sets a part selection views list of image IDs. EXAMPLE: To set the list of image IDs for the
     * Cannon selection view, the parameter view would be ShipBuildingState.CANNON and partImageIds
     ...
     */
	void setPartViewImageList(ShipBuildingState view, List<Integer> partImageIds);
     ...
     *             no text to display.
     */
    void setArrow(ShipBuildingState partView, ViewDirection arrow, boolean visible, String text);
}
